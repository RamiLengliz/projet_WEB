    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="../model/update_reservation.php" method="post" style="max-width: 100rem; padding: 20px; margin-bottom: 20px; border: 1px solid #ccc; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
