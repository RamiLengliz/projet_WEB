							...
							<div class="chat-window">
								...
								<div class="chat-cont-right">
									...
									<div class="chat-footer">
										<form action="../../model/send_message.php" method="post" enctype="multipart/form-data">
											<div class="input-group">
												...
												<input type="hidden" name="id_user" value="68"> <!-- Replace USER_ID with actual user ID -->
												<input type="hidden" name="id_reclamation" value="10"> <!-- Replace RECLAMATION_ID with actual reclamation ID -->
