        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12" style="padding-top:20px;">
                    <form action="../model/submit_results.php" method="POST" onsubmit="return confirm('Are you sure you want to submit these results?');">
            ...
            WHERE 
                ...
                ";
                                    ...
                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        echo "<td><input type='text' value='' name='results[" . $row['id'] . "][note]' placeholder='Enter result'></td>";
