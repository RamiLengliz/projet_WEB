                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="index.php?page=list_etudiant_update" method="POST">
                                                        <input type="hidden" name="id_examen" value="<?= htmlspecialchars($examen['id']); ?>">
                                                        <input type="hidden" name="id_class" value="<?= htmlspecialchars($examen['id_class']); ?>">
                                                        <button class="btn btn-primary" type="submit">mise a jour les notes des etudiants</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php }; ?>
