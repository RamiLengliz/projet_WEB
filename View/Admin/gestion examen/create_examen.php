    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="../../Model/gestion examen/create_examen.php" method="post" style="max-width: 100rem; padding: 20px; margin-bottom: 20px; border: 1px solid #ccc; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <button type="submit" id="sendEmailButton" onclick="sendEmail()" class="btn btn-warning btn-lg w-100 mb-3">
                ...
                <script>
                    function sendEmail() {
                        ...
                        sendEmailButton.style.transition = 'opacity 0.5s';
                        sendEmailButton.style.opacity = '0';
                        setTimeout(() => {
                            sendEmailButton.style.display = 'none';
                            const loadingButton = document.createElement('button');
                            loadingButton.className = 'btn btn-warning btn-lg w-100 mb-3';
                            ...
                            `;
                            sendEmailButton.parentNode.appendChild(loadingButton);
                            loadingButton.style.opacity = '1';
                        }, 500);

                        const xhr = new XMLHttpRequest();
                        xhr.open("GET", "../../Model/gestion examen/examen_pdf.php", true);
                        xhr.onreadystatechange = function() {
                            if (xhr.readyState === 4 && xhr.status === 200) {
                                console.log("Emails sent successfully!");
                                window.location.href = "../../Model/gestion examen/examen_pdf.php";
                                setTimeout(() => {
                                    window.location.href = "../../Model/gestion examen/examen_pdf.php"; // Redirect to the page
                                }, 2000);
                            }
                        };
                        xhr.send();
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="../../Model/gestion examen/delete_examen.php?id=<?= $examen['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this event?');">Delete</a>
                                                </td>
                                            </tr>
                                        <?php }; ?>
                                    </tbody>
