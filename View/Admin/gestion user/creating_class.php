    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                switch ($result) {
                    case '1':
                        echo '<div class="alert alert-success" role="alert">class created successfully !</div>
                    ...
                    case '3':
                        ...
                        break;
                    case '4':
                        echo '<div class="alert alert-warning" role="alert">Class already exists.!</div>
                ...
                <div class="card-header">
                    ...
                    <div class="card-body text-dark">
                        <form class="row g-3" method="POST" action="../../model/gestion user/creating_class.php">
                            <div class="col-md-6">
                                <label for="class" class="form-label">Name</label>
                                <input type="text" class="form-control" id="clsas" name="class" required>
