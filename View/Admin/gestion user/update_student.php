            ...
            <div class="col-md-12">
                ...
                <div class="card-header">
                    ...
                    <div class="card-body text-dark">
                        <form class="row g-3" method="POST" action="../../model/gestion user/update_student.php">
                            ...
                            <div class="col-md-12">
                                <label for="selectlabel" class="form-label">Class</label>
                                <select class="form-select" id="classSelect" name="class" value="<?= $user['class']; ?>" required>
