...
<div class="course-feature">
                ...
                <div class="product">
                    <div class="product-img">
                        <a href="course-details.html">
                            <img class="img-fluid" alt="" src="../../../Admin/<?= $cours['ressourceCours'] ?>">
                        </a>
                        ...
                        <div class="course-group d-flex">
                            <div class="course-group-img d-flex">
                                <div class="course-name">
                                    <h4><a href="instructor-profile.html"><?php echo $cours['nomCours']; ?></a></h4>
                                </div>
                            </div>
    ...
    <?php echo '<td><a href="../../../View/admin/gestion cours/' . $cours['ressourceCours'] . '" class="btn btn-primary" download>Generate PDF</a></td>'?>
