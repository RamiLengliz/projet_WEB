...
require_once '../../../model/gestion reclamation/reclamation.php';
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="../../../Model/gestion reclamation/update_reclamation.php" method="post" style="max-width: 100rem; padding: 20px; margin-bottom: 20px; border: 1px solid #ccc; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
                        ...
                        <?php foreach ($reclamations as $rec) : $subject_name=$subjectC->getSubject($reclamation['Subject']);
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../../../../Model/gestion reclamation/delete_reclamation.php?id=<?= $rec['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this reclamation?');">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
