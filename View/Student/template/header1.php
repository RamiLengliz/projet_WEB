			...
			<div class="container">
				<div class="navbar-header">
					...
					<a href="index.php" class="navbar-brand logo">
						<img src="assets/img/proschool-logo.png" class="img-fluid" alt="Logo">
					</a>
				</div>
					...
					<ul class="main-nav">
						...
						<li class="has-submenu">
							...
							<ul class="submenu">
								...
								<li><a href="events_front.php">Your Events</a></li>
								<li><a href="absence_front.php">Absence</a></li>
						...
						<li class="has-submenu active">
							...
							<ul class="submenu">
								...
								<li class="has-submenu active">
									<a href="course-list.html">Reclamation</a>
									<ul class="submenu">
										<li class="active"><a href="add-reclamation.php">Add Reclamation</a></li>
				...
				<ul class="nav header-navbar-rht">
					<li class="nav-item">
						<a href="course-message.php"><img src="assets/img/icon/messages.svg" alt="img"></a>
					</li>
					...
					<li class="nav-item user-nav">
						<a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
							<span class="user-img">
								<img src="../../admin/gestion user/face_recognition/photos/<?=htmlspecialchars($_SESSION['id']);?>.png" alt="">
						...
						<div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
							<div class="user-header">
								<div class="avatar avatar-sm">
									<img src="../../admin/gestion user/face_recognition/photos/<?=htmlspecialchars($_SESSION['id']);?>.png" alt="User Image" class="avatar-img rounded-circle">
								</div>
								<div class="user-text">
									<h6><?=
							...
							<a class="dropdown-item" href="change_password.php"><i class="feather-settings me-1"></i> Settings</a>
							...
							<a class="dropdown-item" href="../../../Model/gestion user/logout.php"><i class="feather-log-out me-1"></i> Logout</a>
						</div>
					</li>
				</ul>
			</div>
