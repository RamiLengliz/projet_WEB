					...
					<div class="col-md-7">
						<div class="home-slide-face aos" data-aos="fade-up">
							<div class="home-slide-text ">
								<h5>The Leader in School Management</h5>
								<h1>Proschool  <br>Make your school Comfortable</h1>
								<p>Own your future learning new skills </p>
							</div>

							<div class="trust-user">
								<p>Enjoy using the platform <br>If there is anything don't be shy and reclame in the reclamation section</p>
			...
			<div class="container">
				<div class="section-header aos" data-aos="fade-up">
					<div class="section-sub-head">
						<span>Your Purchased Online Tickets</span>
						<h2>Online Tickets</h2>
					</div>
					<div class="all-btn all-category d-flex align-items-center">
						<a href="events_front.php" class="btn btn-primary">Events</a>
					</div>
				</div>
				<div class="section-text aos" data-aos="fade-up">
					<p>Just show the bodyguard the online ticket and have fun you and your friends.</p>
				</div>
				<div class="owl-carousel mentoring-course owl-theme aos" data-aos="fade-up">
					<?php $eventC->generateEventss($events); ?>
