    ...
    <ul class="sidebar-nav">
        ...
        <li class="sidebar-item">
            ...
            <ul id="coursesManagement" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                ...
                <li class="sidebar-item">
            <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#AbsenceManagement" aria-expanded="false" aria-controls="AbsenceManagement">
        ...
        <li class="sidebar-item">
            <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#EventsManagement" aria-expanded="false" aria-controls="EventsManagement">
