...
<body style="text-decoration:none !important;">
  <div class="container-fluid">
    <form class="mx-auto" method="POST" action="admin/gestion user/face_recognition/compare.php">
      <div class="row">
     ...
     elseif ($page == '5') {
      ...
      echo '<div class="alert alert-danger" role="alert">Faces does not match.</div>';
    }
      ?>
      <div class="mb-3 mt-5">
