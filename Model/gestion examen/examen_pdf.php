...
require_once '../../vendor/autoload.php'; // Assuming you have PHPMailer installed via Composer
...
header('Location:../../View/admin/index.php?page=CE&result=5');
