...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['results'], $_POST['id_examen'])) {
    ...
    header("Location: ../view/index.php?page=resultat_update&result=1"); // Redirect after submit with a success message
} else {
    header("Location: ../view/index.php?page=resultat_update&result=2"); // Redirect with an error message
}
